...
func main() {
	...
	router.HandleFunc("/health-check", func(writer http.ResponseWriter, request *http.Request) {
	...
	router.HandleFunc("/file", func(writer http.ResponseWriter, request *http.Request) {
	...
	router.HandleFunc("/file/{name}", func(writer http.ResponseWriter, request *http.Request) {
